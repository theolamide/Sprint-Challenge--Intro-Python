...
class CompTests(unittest.TestCase):
    ...
    def test_name_hyphen_age(self):
        self.assertEqual(e, [
            'Alice-29', 'Bob-32', 'Charlie-37', 'Daphne-30', 'Eve-26',
            'Frank-18', 'Glenn-42', 'Harrison-12', 'Igon-41', 'David-31'
        ])
    ...
    def test_square_root_of_ages(self):
        self.assertEqual(h, [
            5.385164807134504, 5.656854249492381, 6.082762530298219,
            5.477225575051661, 5.0990195135927845, 4.242640687119285,
            6.48074069840786, 3.4641016151377544, 6.4031242374328485,
            5.5677643628300215
        ])
